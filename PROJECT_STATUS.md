...
- [ ] **子代理（Task）熟练运用**: 正在学习通过 task 工具启动子代理进行并行任务处理。
...
5. [ ] **子代理学习 - 基础入门**: 启动 explore 子代理分析 PetClinic 模块。
6. [ ] **子代理学习 - 结果整合**: 整合多个子代理结果并验证准确性。
7. [ ] **子代理学习 - 通用代理**: 使用 general 子代理研究技术问题。
8. [ ] **子代理学习 - 高级技巧**: 掌握 task_id 续话和复杂 prompt 设计。
9. [ ] **子代理学习 - 综合实战**: 多代理协作生成架构分析报告。
